    ...
    public class SnowballEnemy : PhysicsProp
    {
        ...
        public void ThrowSnowballClientRpc(NetworkObjectReference enemyObject, Vector3 targetPosition)
        {
            if (enemyObject.TryGet(out NetworkObject networkObject))
            {
                ...
                float speed = ConfigManager.frostbiteSnowballSpeed.Value;
                ...
                StartCoroutine(DetectGroundAndWalls());
            }
        }
        ...
        private bool HandleEnemyHit(Collider other)
        {
            ...
            if (enemyCollision.mainScript is FrostbiteAI) return false;
        ...
        public void HitPlayerClientRpc(int playerId, Vector3 position)
        {
            ...
            {
                StartCoroutine(ImmobilizePlayerCoroutine());
